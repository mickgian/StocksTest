...
val appComponent= listOf(createRemoteModule("https://apidojo-yahoo-finance-v1.p.rapidapi.com/"), repositoryModule, featureHomeModule, featureDetailModule, localModule)
